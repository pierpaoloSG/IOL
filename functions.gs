...
function convertObjdateToText(date){
...
function retrieveRegione(){

var provincia = 'CT'
var data = sheetGeografica.getDataRange().getValues()
var headers = data[0]
var geografica = ObjApp.rangeToObjectsNoCamel(data)
Logger.log(geografica)
var objProvincia = geografica.filter(function (el) {
  return el['Sigla automobilistica'] == provincia
});
Logger.log(objProvincia)
return objProvincia[0]['Denominazione regione']
